...
struct LocationView: View {
    ...
    var body: some View {
        ...
        ScrollView{
            ...
            DatafieldView(valueArray: $carbonMArray, dateArray: $dateArray, dataTitle: "Carbon Monoxide (CO)", graphTitle: "CO over time", label: "CO (ppm)", color: Color.red)
            
            //Data part for carbon dioxide (CO₂)
            DatafieldView(valueArray: $carbonDArray, dateArray: $dateArray, dataTitle: "Carbon Dioxide (CO₂)", graphTitle: "CO₂ over time", label: "CO₂ (ppm)", color: Color.green)
            
            //Data part for nitrogen dioxide (NO₂)
            DatafieldView(valueArray: $nitroArray, dateArray: $dateArray, dataTitle: "Nitrogen Dioxide (NO₂)", graphTitle: "NO₂ over time", label: "NO₂ (pphm)", color: Color.purple)
            
            //Data part for sulphur dioxide (SO₂)
            DatafieldView(valueArray: $sulphurArray, dateArray: $dateArray, dataTitle: "Sulphur Dioxide (O₂)", graphTitle: "SO₂ over time", label: "SO₂ (pphm)", color: Color.pink)
            
            //Data part for ozone (O₃)
            DatafieldView(valueArray: $ozoneArray, dateArray: $dateArray, dataTitle: "Ozone (O₃)", graphTitle: "O₃ over time", label: "O₃ (pphm)", color: Color.orange)
